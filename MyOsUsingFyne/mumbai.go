...
func myMumbai(w fyne.Window) {
	...
	apicity := "https://api.weatherapi.com/v1/current.json?key=0d2ae24d649940b4a9274231212910&q=mumbai&aqi=yes"
	...
	dd := widget.NewSelect([]string{"Mumbai", "Delhi", "Kolkata", "Hyderabad", "Mumbai", "Pune", "Lucknow", "Shimla", "Bhopal"}, func(s string) {
		if s == "Mumbai" {
			myMumbai(w)
		} else if s == "Bhopal" {
			myBhopal(w)
